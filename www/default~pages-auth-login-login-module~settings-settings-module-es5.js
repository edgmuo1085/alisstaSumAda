...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-auth-login-login-module~settings-settings-module"], {
  ...
  /***/
  function node_modulesIonicNativeAppRate__ivy_ngcc__NgxIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var SettingsPage = /*#__PURE__*/function () {
      ...
      _createClass(SettingsPage, [{
        ...
        value: function switchNotifications() {
          ...
          if (this.notifications) this.oneSignal.setSubscription(true);else this.oneSignal.setSubscription(false);
        }
        /**
