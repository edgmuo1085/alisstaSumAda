...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function _node_modules_Capacitor_camera_dist_esm_definitionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _node_modules_Capacitor_camera_dist_esm_indexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _node_modules_Capacitor_filesystem_dist_esm_definitionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _node_modules_Capacitor_filesystem_dist_esm_indexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Filesystem = Object(_capacitor_core__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"])('Filesystem', {
      web: function web() {
        ...
        [__webpack_require__.e("common"), __webpack_require__.e("web")]).then(__webpack_require__.bind(null,
        /*! ./web */
        "./node_modules/@capacitor/filesystem/dist/esm/web.js")).then(function (m) {
  ...
  /***/
  function _src_app_services_activities_advisoryTopic_advisoryTopicServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AdvisoryTopicService", function () {
      return AdvisoryTopicService;
    });
    /* harmony import */
    ...
    var AdvisoryTopicService = /*#__PURE__*/function () {
      function AdvisoryTopicService(http) {
        _classCallCheck(this, AdvisoryTopicService);
      ...
      return _createClass(AdvisoryTopicService, [{
        key: "saveActaAsesoria",
        value: function saveActaAsesoria(actaAses) {
          var rq = actaAses;
          console.log(rq);
          return this.http.post(this.API_SAVE_ACTA_ASESORIA, rq);
        }
      }, {
        key: "uploadFileActaAsesoria",
        value: function uploadFileActaAsesoria(file) {
          var rq = file;
          return this.http.post(this.API_UPLOAD_FILE_ACTA_ASESORIA, rq);
        } // Envio correo notificacion

      }, {
        key: "enviarCorreoNotificacionActaApp",
        value: function enviarCorreoNotificacionActaApp(correoNotif) {
          var rq = correoNotif;
          console.log(rq);
    ...
    AdvisoryTopicService.ɵfac = function AdvisoryTopicService_Factory(t) {
      return new (t || AdvisoryTopicService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]));
    };

    AdvisoryTopicService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: AdvisoryTopicService,
      factory: AdvisoryTopicService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AdvisoryTopicService, [{
  ...
  /***/
  function _src_app_services_alert_alertServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var AlertService = /*#__PURE__*/function () {
      function AlertService(loadingCtlr, alertCtrl) {
      ...
      return _createClass(AlertService, [{
        key: "showAlert",
        value: function showAlert(header, message, acceptHandler, cancelHandler) {
        ...
        key: "hideAlert",
        value: function hideAlert(alert) {
        ...
        key: "hideLoading",
        value: function hideLoading(alert) {
    ...
    AlertService.ɵfac = function AlertService_Factory(t) {
      return new (t || AlertService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"]));
    };
  ...
  /***/
  function _src_app_services_attach_photoServiceServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "PhotoServiceService", function () {
    ...
    var PhotoServiceService = /*#__PURE__*/function () {
      function PhotoServiceService() {
        _classCallCheck(this, PhotoServiceService);

        this.photos = [];
      }

      return _createClass(PhotoServiceService, [{
        key: "addNewToGallery",
        value: function addNewToGallery() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
            var capturedPhoto, fotoIngresada;
            return _regeneratorRuntime().wrap(function _callee7$(_context7) {
              while (1) switch (_context7.prev = _context7.next) {
                ...
                case 2:
                  ...
                  return _context7.abrupt("return", fotoIngresada);
        ...
        key: "deletePhoto",
        value: function deletePhoto(photoSelected, index) {
          var idFotoAEliminar = photoSelected.idFoto;
          var encontro = this.photos.find(function (x) {
            return x.idFoto === idFotoAEliminar;
          });
    ...
    PhotoServiceService.ɵfac = function PhotoServiceService_Factory(t) {
      return new (t || PhotoServiceService)();
    };

    PhotoServiceService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: PhotoServiceService,
      factory: PhotoServiceService.ɵfac,
      providedIn: 'root'
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PhotoServiceService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"],
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  function _src_app_services_event_eventServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var EventService = /*#__PURE__*/function () {
      function EventService(http) {
        ...
        this.http = http; // API_USERREGISTREMODEL = environment.API_GETUSERREGISTEREVENT;
      ...
      return _createClass(EventService, [{
        key: "getBranchOfficeEvent",
        value: function getBranchOfficeEvent() {
        ...
        key: "getMunicipyBrachOffice",
        value: function getMunicipyBrachOffice(idBranchOffice) {
          var urlGetMunicipyBranchOffice = "".concat(this.API_SEARCH_MUNICIPY_BRANCH_OFFICE_FOR_EVENT, "?Fk_Id_Sucursal=").concat(idBranchOffice);
        ...
        key: "getEventForMunicipy",
        value: function getEventForMunicipy(idMunicipy) {
          var urlEventForMunicipy = "".concat(this.API_SEARCH_EVENT_FOR_MUNICIPY, "?FK_Id_Municipio=").concat(idMunicipy);
        ...
        key: "createEventResponsible",
        value: function createEventResponsible(responsibleEvent) {
        ...
        key: "registerResponsibleQR",
        value: function registerResponsibleQR(resposibleEventQR) {
        ...
        key: "registerResponsibleManual",
        value: function registerResponsibleManual(responsibleEventManual) {
        ...
        key: "getSearchResponsibleEventManual",
        value: function getSearchResponsibleEventManual(documentoAsistente, idEvento) {
          var urlSearchResponsibleManualEvent = "".concat(this.API_SEARCH_RESPONSIBLE_MANUAL_EVENT, "?NumeroIdentificacionEmpleado=").concat(documentoAsistente, "&Fk_Id_Evento=").concat(idEvento);
