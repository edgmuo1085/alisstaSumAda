...
- (BOOL)showForPhone:(NSMutableDictionary *)options {
  ...
  [self.viewController.view addSubview: self.datePickerContainer];
...
- (UIPopoverController *)createPopover:(NSMutableDictionary *)options {
  ...
  [popover presentPopoverFromRect:anchor inView:self.viewController.view  permittedArrowDirections:arrowDirection animated:YES];
