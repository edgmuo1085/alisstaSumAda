...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["release-activities-release-activities-module"], {
  ...
  /***/
  function _src_app_pages_releaseActivities_releaseActivitiesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _src_app_pages_releaseActivities_releaseActivitiesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function _src_app_pages_releaseActivities_releaseActivitiesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function ReleaseActivitiesPage_ion_list_13_ion_row_1_ion_col_12_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ReleaseActivitiesPage_ion_list_13_ion_row_1_ion_col_12_Template_ion_checkbox_click_28_listener() {
          ...
          var activity_r7 = ctx.$implicit;

          var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](3);

          return ctx_r9.activitySelected(activity_r7);
        });
    ...
    function ReleaseActivitiesPage_ion_button_14_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "ion-button", 23);

        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ReleaseActivitiesPage_ion_button_14_Template_ion_button_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r12);

          var ctx_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

          return ctx_r11.liberarActividad();
        });
    ...
    var ReleaseActivitiesPage = /*#__PURE__*/function () {
      ...
      return _createClass(ReleaseActivitiesPage, [{
          ...
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                ...
                case 5:
                  this.listActivity = _context.sent;
                  console.log("UsuarioStorageado: ", this.informacionUsuario); // this.presentLoading();
                  ...
                  console.log("LIstado de Actividades 2.0: ", this.listActivity); // this.loading.dismiss();
        ...
        value: function liberarActividad() {
          return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var idActividadesSeleccionadas, objLiberar, siLiberoActividades, listaActividades;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  // Mostrar el indicador de carga
                  this.presentLoading(); // Obtener los IDs de las actividades seleccionadas

                  idActividadesSeleccionadas = this.actividadesSeleccionadas.map(function (element) {
                    return element.id;
                ...
                case 5:
                  ...
                  // Notificar éxito
                  this.notification('Atención', 'Se logró liberar la(s) actividad(es) seleccionadas'); // Obtener la lista de actividades del storage
                ...
                case 13:
                  ...
                  listaActividades.forEach(function (actividad) {
                    if (actividad.listaActividadesMigradas) {
                      actividad.listaActividadesMigradas = actividad.listaActividadesMigradas.filter(function (actMigrada) {
                        return !idActividadesSeleccionadas.includes(actMigrada.id);
                      });
                    }
                  }); // Guardar nuevamente en el storage la lista actualizada

                  _context2.next = 17;
                  return this.storage.set('listaActividades', listaActividades);
    ...
    ReleaseActivitiesPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      decls: 15,
      vars: 3,
      consts: [["size", "2"], ["color", "tertiary"], ["slot", "start"], ["color", "primary", "mode", "md", "defaultHref", "/"], ["size", "10"], [1, "titulo"], [1, "ion-padding"], ["animated", "", "color", "primary", "placeholder", "Buscar", 3, "ionChange"], ["mode", "ios", 4, "ngIf"], ["class", "mb-4", 4, "ngIf"], ["class", "boton-flotante", "color", "primary", 3, "disabled", "click", 4, "ngIf"], ["mode", "ios"], ["size", "12"], [1, "ion-text-center"], ["src", "../../../assets/icon/icono_observaciones.svg", "alt", "", 1, "imgIcono"], [1, "tituloSlide"], [1, "mb-4"], ["class", "ion-margin-bottom", 4, "ngFor", "ngForOf"], [1, "ion-margin-bottom"], [1, "bold"], ["size", "12", 4, "ngFor", "ngForOf"], ["lines", "none"], ["slot", "end", "color", "primary", 3, "value", "click"], ["color", "primary", 1, "boton-flotante", 3, "disabled", "click"]],
