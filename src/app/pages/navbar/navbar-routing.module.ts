...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('../educa/select-register-event/select-register-event.module')
          .then(m => m.SelectRegisterEventPageModule)
      },
      {
        path: 'manual-event-register',
        loadChildren: () => import('../educa/manual-event-register/manual-event-register.module')
          .then(m => m.ManualEventRegisterPageModule)
      },
      {
        path: 'info-register-event-manual',
        loadChildren: () => import('../educa/info-register-event-manual/info-register-event-manual.module')
          .then(m => m.InfoRegisterEventManualPageModule)
      },
      {
        path: 'list-communications',
        loadChildren: () => import('../communications/list-communications/list-communications.module').then( m => m.ListCommunicationsPageModule)
      },
      {
      ...
      },
      {
        ...
        loadChildren: () => import('../communications/create-communication/create-communication.module').then( m => m.CreateCommunicationPageModule)
      },
      {
        path: 'companies',
