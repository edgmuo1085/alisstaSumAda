...
export class FollowUpPage {
  ...
  private initForm(): void {
    const implementadaControl = new UntypedFormControl(this.recomendacion.implementada, [Validators.required]);
    const fechaImplementacionControl = new UntypedFormControl(this.recomendacion.Fecha_Implementacion, [Validators.required]);
    const eficaciaControl = new UntypedFormControl(this.recomendacion.fueronEficaces, [Validators.required]);
    const causaControl = new UntypedFormControl(this.recomendacion.causaNoImplementancion, [Validators.required]);
    const nombreSoporteControl = new UntypedFormControl(this.recomendacion.InformacionEnvidencia, []);
